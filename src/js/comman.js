document.addEventListener("DOMContentLoaded", function () {
    ...
    document.addEventListener("click", function (e) {
        if (!e.target.closest(".mobile-dropdown")) {
            ...
            document.querySelectorAll(".mobile-dropdown-trigger")
                .forEach(el => el.classList.remove("active"));
        }
    });
    ...
    if (window.matchMedia("(min-width: 992px)").matches) {
        ...
        dropdownTriggers.forEach(trigger => {
            ...
            menuItem.addEventListener("mouseenter", () => {
                ...
                document.querySelectorAll(".sazs-submenu")
                    .forEach(el => el.classList.remove("active"));

                document.querySelectorAll(".sazs-menu-item")
                    .forEach(el => el.classList.remove("active"));
    ...
    function closeNavOnClickOutside(e) {
        if (!sidenav.contains(e.target) && !e.target.closest(".sazs-hamburger")) {
            closeNav();
        }
    }
